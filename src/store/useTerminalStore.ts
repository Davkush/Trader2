...
interface TerminalState {
  ...
  activeRightPanel: 'order' | 'stats' | 'history' | 'backtest' | 'autotrade' | 'terminal' | 'pinescript' | 'agents' | 'vault' | 'oms' | 'sentiment' | null;
  setActiveRightPanel: (update: 'order' | 'stats' | 'history' | 'backtest' | 'autotrade' | 'terminal' | 'pinescript' | 'agents' | 'vault' | 'oms' | 'sentiment' | null | ((prev: 'order' | 'stats' | 'history' | 'backtest' | 'autotrade' | 'terminal' | 'pinescript' | 'agents' | 'vault' | 'oms' | 'sentiment' | null) => 'order' | 'stats' | 'history' | 'backtest' | 'autotrade' | 'terminal' | 'pinescript' | 'agents' | 'vault' | 'oms' | 'sentiment' | null)) => void;
    ...
    try {
      ...
      if (resp.ok) {
        ...
        if (!contentType.includes('application/json')) {
          if (!silent) {
            set({ botsError: 'Server initializing...' });
          }
          return;
        }
        ...
        try {
          ...
          if (!silent) {
            set({ botsError: 'Server is starting up...' });
          }
          return;
        }
